...
plan = Plan('ИКБО-22-21', 'Прогинж', 'ИТ',
            [Academic('Матан', 2, 'Мат', 'Карпов', 'Зачёт', {'лекция': 10, 'лабораторная': 2}),
             Academic('Линал', 3, 'Мат', 'Карпов', 'Зачёт', {'лабораторная': 1})
            ],
            [
             Practice('ООП', 1, 'ИТ', 'учебная', 'Карпов', ['тема1', 'тема2']),
             Practice('ООП2', 1, 'ИТ2', 'учебная2', 'Карпов2', ['тема1', 'тема2', 'тема3'])
            ]
            )
